...
class RoleController extends Controller
{
    ...
    public function edit(Role $role){
        ...
        $client=DB::table('permissions')->where('section','Setting')->get();
        $position=DB::table('permissions')->where('section','Rolee')->get();
        $resume=DB::table('permissions')->where('section','Permission')->get();
        $interview=DB::table('permissions')->where('section','Branch-Add-tool')->get();
        
        $incentive=DB::table('permissions')->where('section','Branch')->get();
        $leave=DB::table('permissions')->where('section','Admin-Branch')->get();
        ...
        return view('admin.roles.edit', compact('role','client','position','resume','interview','incentive','leave'));
